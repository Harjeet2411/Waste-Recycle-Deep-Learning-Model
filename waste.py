...
st.title('SRET Organic and Inorganic Waste Prediction')
st.markdown('Application is to verify wheather your waste may be recyclable or not.')
st.markdown('Project is generated by Miracle Workers [Harjeet JL & Priya Darshini] from SRET ')
...
if page == "Sample Data":
    ...
    if st.checkbox('Show Sample Data'):
        ...
        if st.checkbox('Show Prediction of simple image'):
            ...
            st.write(result)
            if result[0][0] == 1:
                prediction = 'Recyclable Waste (Inorganic)'
            else:
